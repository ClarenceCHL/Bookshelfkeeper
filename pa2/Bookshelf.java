...
public class Bookshelf {
    ...
    /**
      ...
      -- all books in bookshelf are positive integers
   ...
   */
   ...
   public void addLast(int height) {
      bookshelf.add(bookshelf.size(), height);
      assert isValidBookshelf();
   }
   ...
   public boolean isSorted() {
      for(int i = 1; i < bookshelf.size(); i++){
         // return false if the height of previous book is larger than that of the current book
         if(bookshelf.get(i - 1) > bookshelf.get(i)) return false;
      }
      assert isValidBookshelf();
      return true;
   }
   ...
   private boolean isValidBookshelf() {
      for(int i = 0; i < bookshelf.size(); i++){
         ...
         if(bookshelf.get(i) <= 0 || bookshelf.get(i) != (int)bookshelf.get(i))
            return false;
      }
      return true;
